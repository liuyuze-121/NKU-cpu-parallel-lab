...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{matrix_comparison.png}
\caption{n*n 矩阵与向量内积进阶算法性能对比图}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{sum_comparison.png}
\caption{n 个数求和进阶算法性能对比图}
\end{figure}
