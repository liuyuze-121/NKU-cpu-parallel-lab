...
\begin{table}[!htbp]
  ...
  simd\_flat\_search (NEON) & 0.99995 & 6958.38 & 3.14$\times$ \\
  \bottomrule
  \end{tabular}
...
\begin{table}[!htbp]
  ...
  \midrule
  50 & 0.9739 & 15344.7 & 1.42$\times$ \\
  100 & 0.9968 & 15205.6 & 1.44$\times$ \\
  200 & 0.9995 & 15453.2 & 1.41$\times$ \\
  500 & 0.99995 & 15794.5 & 1.38$\times$ \\
  1000 & 0.99995 & 16271.9 & 1.34$\times$ \\
  2000 & 0.99995 & 17237.2 & 1.27$\times$ \\
  5000 & 0.99995 & 20518.9 & 1.06$\times$ \\
  \bottomrule
  \end{tabular}
  \caption{SQ-SIMD性能结果}
...
\begin{itemize}
  ...
  \item \textbf{最佳平衡点}：p=500 时，在保持 full recall 的同时取得最优延迟 15794.5 $\mu$s
...
\begin{table}[!htbp]
  ...
  \midrule
  SQ (p=500) & 0.99995 & 15794.5 & 9.6 MB & 4$\times$ \\
  PQ (两阶段, p=2000) & 0.99995 & 5026.63 & $\sim$0.5 MB & 96$\times$ \\
  \bottomrule
  \end{tabular}
  \caption{PQ-SIMD性能对比}
...
\begin{itemize}
  ...
  \item 查询延迟降至 5026.63 $\mu$s，加速比达到 4.35$\times$
  \item 本地测试中 recall 保持在 0.99995，说明当前实现的两阶段重排有效弥补了量化误差
\end{itemize}
...
\begin{table}[!htbp]
  ...
  simd\_flat\_search & 0.99995 & 6958.38 & 38.4 MB & 1$\times$ & 3.14$\times$ \\
  SQ (p=500) & 0.99995 & 15794.5 & 9.6 MB & 4$\times$ & 1.38$\times$ \\
  PQ (两阶段) & 0.99995 & 5026.63 & $\sim$0.5 MB & 96$\times$ & 4.35$\times$ \\
  \bottomrule
  \end{tabular}
  \caption{算法综合对比}
...
\addplot[fill=blue!50] coordinates {(flat,21842.9) (simd\_flat,6958.38) (SQ,15794.5) (PQ,5026.63)};
\end{axis}
\end{tikzpicture}
...
\begin{itemize}
  ...
  \item \textbf{结果}：3.14$\times$ 加速，recall 保持 0.99995
...
\begin{itemize}
  ...
  \item \textbf{结果}：4$\times$ 压缩，p=500 时延迟 15794.5 $\mu$s，recall 0.99995
...
\begin{itemize}
  ...
  \item \textbf{结果}：96$\times$ 压缩，recall 0.99995，延迟 5026.63 $\mu$s（4.35$\times$ 加速）
...
average latency (us): 15344.7

=== p=100 ===
average recall: 0.9968
average latency (us): 15205.6

=== p=200 ===
average recall: 0.9995
average latency (us): 15453.2

=== p=500 ===
average recall: 0.99995
average latency (us): 15794.5

=== p=1000 ===
average recall: 0.99995
average latency (us): 16271.9

=== p=2000 ===
average recall: 0.99995
average latency (us): 17237.2

=== p=5000 ===
average recall: 0.99995
average latency (us): 20518.9
\end{lstlisting}

\subsection{PQ-SIMD}
\begin{lstlisting}[frame=single]
average recall: 0.99995
average latency (us): 5026.63
\end{lstlisting}
...
GitHub 仓库地址：\href{https://github.com/liuyuze-121/NKU-cpu-parallel-lab/tree/main/lab2_SIMDprograming}{https://github.com/liuyuze-121/NKU-cpu-parallel-lab/tree/main/lab2\_SIMDprograming}
